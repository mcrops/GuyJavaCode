...
package aidev.cocis.makerere.org.whiteflycounter.database;
...
/**
 * I have taken this from Android's SQLiteOpenHelper. However, i can't 
 * appropriately lock the database so there may be issues if a thread opens the
 * database read-only and another thread tries to open the database read/write. 
 * I don't think this will ever happen in WHITEFLYCOUNTER, though. (fingers crossed).
 */
 ...
 * </p>
 */
public abstract class WhiteFlyCounterSQLiteOpenHelper {
	private static final String t = WhiteFlyCounterSQLiteOpenHelper.class.getSimpleName();
	 ...
	 */
	public WhiteFlyCounterSQLiteOpenHelper(String path, String name,
